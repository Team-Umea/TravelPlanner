...
export default function SecondaryBtn({
  ...
  return (
    <button
      ...
      className={`flex justify-center items-center ${width} h-fit text-white font-semibold py-[10px] px-[25px] rounded-full transition-opacity duration-500 cursor-pointer group bg-blue-600
 hover:opacity-60`}>
      {icon && (
