...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-screen bg-transparent text-white z-[100]">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <NavLink to="/" className="flex flex-col items-sttart space-x-3 rtl:space-x-reverse">
          ...
          {isAuthenticated && <p className="text-white drop-shadow-[0_0_1px_rgba(0,0,0,1)] tracking-wider">Logged in as {username}</p>}
        </NavLink>
